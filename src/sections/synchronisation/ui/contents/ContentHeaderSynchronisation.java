 ...
 *
 */
public class ContentHeaderSynchronisation extends JPanel {

	private static final long serialVersionUID = -6376900167151408327L;
	 ...
	 * @param application 
	 */
	public ContentHeaderSynchronisation(final Application application) {
