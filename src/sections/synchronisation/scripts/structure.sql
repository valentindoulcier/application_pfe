...
CREATE  TABLE IF NOT EXISTS `bddictionnairique`.`headword` (
  ...
  `var1` VARCHAR(100) NULL DEFAULT NULL ,
  `var2` VARCHAR(100) NULL DEFAULT NULL ,
  `var3` VARCHAR(100) NULL DEFAULT NULL ,
  `var4` VARCHAR(100) NULL DEFAULT NULL ,
  `var5` VARCHAR(100) NULL DEFAULT NULL ,
  `flag_lien` INT NULL ,
  `flag_autre` INT NULL ,
  `id_note` INT(11) NULL ,
...
CREATE  TABLE IF NOT EXISTS `bddictionnairique`.`syllabes` (
  ...
  `schema` VARCHAR(20) NULL DEFAULT NULL ,
  `nb_syllabes` INT(11) NULL DEFAULT NULL ,
