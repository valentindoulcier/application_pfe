 ...
 *
 */
public class MotsRenderer_3 extends JPanel implements ListSelectionListener, MouseListener {

	private static final long serialVersionUID = -3594983798608599109L;
	
	//private static Logger logger = Logger.getLogger(MotsRenderer_3.class);

	public static JList maListe;
	public JScrollPane scrollPane;
	public Vector<RSDetail_3> listeItems;
